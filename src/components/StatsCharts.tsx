...
import StatsChart from '../components/StatsChart'; // <--- IMPORT DU GRAPHIQUE
...
export default function DashboardPage() {
  ...
  const [allTours, setAllTours] = useState<any[]>([]); // Pour le graphique
  ...
  useEffect(() => {
    async function loadStats() {
      try {
        ...
        setAllTours(toursRes.data); // On garde toutes les tournées pour le graph
